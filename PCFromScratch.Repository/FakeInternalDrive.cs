...
public class FakeInternalDrive : IInternalDriveRepository
{
    ...
    {
        new() { Id = Guid.NewGuid(), Link = "link", Name = "Kingston KC3000 1TB M.2 2280 NVMe PCIe 4.0", Capacity = 1000, Type = "SSD", Format = "M.2", Port = "PCIe 4.0" },
        new() { Id = Guid.NewGuid(), Link = "link", Name = "Samsung 990 PRO 2TB M.2 2280 NVMe PCIe 4.0", Capacity = 2000, Type = "SSD", Format = "M.2", Port = "PCIe 4.0" },
        new() { Id = Guid.NewGuid(), Link = "link", Name = "Crucial BX500 500GB 2.5 SATAIII", Capacity = 500, Type = "SSD", Format = "2.5", Port = "SATA III" },
        new() { Id = Guid.NewGuid(), Link = "link", Name = "WD Blue 1TB 7200rpm 64MB 3.5 SATA III", Capacity = 1000, Type = "HDD", Format = "3.5", Port = "SATA III" }
    };
